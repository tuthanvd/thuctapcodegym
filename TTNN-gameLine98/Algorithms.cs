...
namespace TTNN_gameLine98
{
    class Algorithms
    {
        ...
        public static int[,] createNewMatrix()//Tao 5 vien bi dau tien
        {
        ...
        public static void addNextColor(int[,] a) //cac cien bi sap xuat hien
        {
            Random random = new Random();
        ...
        public static ArrayList havePath(int[,] a, int i1, int j1, int i2, int j2)//tim duong di cho vien bi
        {
            int[,] dadi = new int[9, 9];//ghi nhan o di ke truoc tren duong dang tim kiem
        ...
        public static ArrayList checkLines(int[,] a, int iCenter, int jCenter)//an diem theo duong thang voi so bi 5
        {
